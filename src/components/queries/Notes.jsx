...
const Notes = () => {
  const { paper, notes, setNotes, user } = useUser();
  ...
  return (
    <main>
      ...
      <ul className="grid grid-cols-1 font-semibold sm:grid-cols-2 lg:flex lg:items-center lg:justify-start lg:gap-16">
        ...
        <li>
          <Link
            className="rounded-md px-2 py-1 underline decoration-blue-800  decoration-2 underline-offset-2 hover:bg-blue-950 hover:text-slate-100 hover:decoration-0 dark:decoration-inherit dark:hover:bg-blue-800/80 dark:hover:text-slate-200 md:p-2 "
            to="students"
          >
            Students
          </Link>
        ...
        {notes?.map((note, index) => (
          ...
          >
            <details className="duration-200">
                  ...
                  {user.userType === "staff" && (
                    <div className="flex p-3 pb-1">
                      <Link to={`${index}/edit`} id={index}>
                        <FaEdit className="ml-2 duration-200 rounded-md p-1 text-3xl hover:bg-blue-800 hover:text-slate-100 dark:hover:bg-blue-600 lg:p-2 lg:text-4xl" />
                      </Link>
                      <Link
                        id={note._id}
              ...
              <hr className="border-b-[1.5px] border-blue-800 dark:border-slate-500 " />
