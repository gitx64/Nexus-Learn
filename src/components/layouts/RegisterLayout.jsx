...
const RegisterLayout = () => {
  ...
  return (
    ...
    >
      <CircleDesign />
      <section className="my-8 flex h-fit w-auto animate-fadeInFast flex-col duration-200 justify-start gap-6 rounded-md bg-slate-100 p-4 text-slate-900 opacity-70 hover:opacity-100 focus:opacity-100 dark:bg-[#060913] dark:text-slate-50 md:p-8 lg:flex-row xl:w-1/2 ">
        <div className="flex flex-col-reverse justify-between lg:flex-col">
          ...
          <img src="/nexusLearn.png" alt="Nexus-Learn Logo" className="h-auto w-auto md:h-50 w-80 " />
          <div className="m-2 flex flex-col-reverse gap-4 text-4xl md:text-5xl  lg:flex-col ">
            ...
            >
              {/* <FaUniversity />
              <p className="decoration-blue-800 decoration-2 hover:underline dark:decoration-blue-300">
                K
                <span className=" inline-block h-3 w-3 rounded-full bg-blue-800 dark:bg-blue-500 "></span>
                llege
              </p> */}
            </Link>
          </div>
