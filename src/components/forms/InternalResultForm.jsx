    ...
    <main className="internal">
      ...
      <section className="form__head">
        <form className="w-full gap-4 accent-blue-800 md:flex">
          <select
            className="mb-4 block h-10 w-full rounded-md border-[1.5px] border-solid border-slate-400 p-1 pl-2 outline-none selection:border-slate-200 focus:border-blue-800 dark:border-slate-200 dark:caret-inherit dark:focus:border-blue-400 dark:active:border-blue-400 md:w-1/3"
          ...
          <button
            className="mb-4 h-10 w-auto rounded-md border-[1.5px] border-solid border-blue-800 bg-slate-800 px-8 py-2 font-semibold tracking-wide text-slate-200 hover:bg-blue-800 focus:bg-blue-800 disabled:cursor-not-allowed dark:border-blue-300 dark:bg-blue-800 dark:text-blue-100 dark:hover:bg-slate-900"
            type="submit"
        ...
        <form className="internal__body__form group">
                  ...
                  {internal?.map((student, index) => (
                    <tr
                      ...
                      className={
                        ...
                        12
                          ? "border-t-[1px] border-slate-400 bg-blue-800/50 first:border-none"
          ...
          {internal.length && disabled ? (
            <div className="flex gap-4">
              ...
              <button
                type="submit"
                className="mb-4 flex h-10 w-auto items-center gap-2 rounded-md border-[1.5px] border-solid border-blue-800 bg-slate-800 px-6 py-2 font-semibold tracking-wide text-slate-200 hover:bg-red-700 focus:bg-blue-800 dark:border-blue-300 dark:bg-blue-800 dark:text-blue-100 dark:hover:bg-red-700"
          ...
          {internal.length && !disabled ? (
            <button
              type="submit"
              className="mb-4 flex h-10 group-invalid:hidden w-auto items-center gap-2 rounded-md border-[1.5px] border-solid border-blue-800 bg-slate-800 px-6 py-2 font-semibold tracking-wide text-slate-200 hover:bg-blue-800 focus:bg-blue-800 dark:border-blue-300 dark:bg-blue-800 dark:text-blue-100 dark:hover:bg-slate-900"
