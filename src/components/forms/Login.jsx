...
//               K
//               <span className="inline-block h-10 w-10 rounded-full bg-blue-800 dark:bg-blue-600 md:h-14 md:w-14 xl:h-14 xl:w-14"></span>
//               llege
//             </h1> */}
//             <img src=
//           </section>
...
//                   <label
//                     className="radio relative flex w-1/2 cursor-pointer flex-col items-center rounded-tl-lg p-4 dark:border-l-[1.5px] dark:border-t-[1.5px]  dark:border-solid dark:border-blue-800"
//                     htmlFor="staff"
//                   >
//                     Staff
//                     <input
...
//                   </label>
//                   <label
//                     className="radio relative flex w-1/2 cursor-pointer flex-col items-center rounded-tr-lg p-4 dark:border-r-[1.5px] dark:border-t-[1.5px] dark:border-solid dark:border-blue-800"
//                     htmlFor="student"
//                   >
//                     Student
//                     <input
...
//                   </label>
//                 </div>
//                 <div className="flex duration-200 w-full justify-center p-1 pt-0 text-8xl dark:border-x-[1.5px] dark:border-solid dark:border-blue-800 md:p-3 md:pt-0">
//                   {userType === "student" ? (
...
//                 </div>
//               </section>
//               <section className="rounded-b-lg px-4 pb-4 dark:border-x-[1.5px] dark:border-b-[1.5px] dark:border-solid dark:border-blue-800">
//               {userType?
//               <>
//                 <input
...
//                   />
//                 <button
//                   className="mb-1 flex h-10 w-full items-center justify-center gap-1 rounded-md border-[1.5px] border-solid border-blue-800 bg-slate-800 p-1 font-bold tracking-wide text-slate-200 hover:bg-blue-800 focus:bg-blue-800 disabled:cursor-wait dark:border-blue-300 dark:bg-blue-600 dark:text-slate-50 dark:hover:bg-slate-900 dark:focus:bg-slate-900 lg:mb-2 "
//                   type="submit"
//                   value="Login"
