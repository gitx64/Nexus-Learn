                  ...
                  <table className="w-full text-left">
                    ...
                    <tbody>
                      {papers?.map((paper, index) => (
                        <tr key={index}>
                          <td className="border-t-[1px] border-blue-400 dark:border-slate-400 px-4 py-2">
                            {paper.paper}
                          </td>
                          <td className="border-t-[1px] border-blue-400 dark:border-slate-400 px-4 py-2">
                            {paper.department}
                          ...
                          <td className="border-t-[1px] border-blue-400 dark:border-slate-400 p-0">
                            {!paper.joined ? (
                              <button
                                type="button"
                                id={paper._id}
                                ...
                                className="m-0 flex h-auto w-full justify-center bg-transparent py-3  text-lg  hover:bg-blue-800 hover:text-slate-100 dark:text-slate-100 "
                              >
                                Join
                              </button>
                            ) : (
